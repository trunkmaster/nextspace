...
# SYSTEM domain
#
GNUSTEP_SYSTEM_APPS        ?= /usr/NextSpace/Apps
GNUSTEP_SYSTEM_ADMIN_APPS  ?= /usr/NextSpace/Apps
GNUSTEP_SYSTEM_WEB_APPS    ?= /usr/NextSpace/WebApps
GNUSTEP_SYSTEM_TOOLS       ?= /usr/NextSpace/bin
GNUSTEP_SYSTEM_ADMIN_TOOLS ?= /usr/NextSpace/sbin
GNUSTEP_SYSTEM_LIBRARY     ?= /usr/NextSpace
GNUSTEP_SYSTEM_HEADERS     ?= /usr/NextSpace/include
GNUSTEP_SYSTEM_LIBRARIES   ?= /usr/NextSpace/lib
GNUSTEP_SYSTEM_DOC         ?= /usr/NextSpace/Documentation
GNUSTEP_SYSTEM_DOC_MAN     ?= /usr/NextSpace/Documentation/man
GNUSTEP_SYSTEM_DOC_INFO    ?= /usr/NextSpace/Documentation/info
