...
static OSEFileManager *sharedManager;
...
@implementation OSEFileManager

+ (OSEFileManager *)defaultManager
{
  if (sharedManager == nil) {
    sharedManager = [[OSEFileManager alloc] init];
  }
...
{
  return [[[OSEDefaults globalUserDefaults] reload] boolForKey:NXTShowHiddenFiles];
}
- (void)setShowHiddenFiles:(BOOL)yn
{
  OSEDefaults *defs = [[OSEDefaults globalUserDefaults] reload];
