...
static void MPRE(blit_alpha_opaque)(unsigned char *adst, const unsigned char *asrc, unsigned char r,
...
static void MPRE(blit_mono_opaque)(unsigned char *adst, const unsigned char *src, int src_ofs,
...
static void MPRE(blit_alpha)(unsigned char *adst, const unsigned char *asrc, unsigned char r,
                             unsigned char g, unsigned char b, unsigned char alpha, int num)
{
  const unsigned char *src = asrc;
  BLEND_TYPE *dst = (BLEND_TYPE *)adst;
  int a, nr, ng, nb;
...
static void MPRE(blit_mono)(unsigned char *adst, const unsigned char *src, int src_ofs,
...
static void MPRE(blit_alpha_a)(unsigned char *adst, unsigned char *dsta, const unsigned char *asrc,
                               unsigned char r, unsigned char g, unsigned char b,
                               unsigned char a_alpha, int num)
{
  const unsigned char *src = asrc;
  BLEND_TYPE *dst = (BLEND_TYPE *)adst;
  int a, nr, ng, nb, na;
...
static void MPRE(blit_mono_a)(unsigned char *adst, unsigned char *dsta, const unsigned char *src,
                              int src_ofs, unsigned char r, unsigned char g, unsigned char b,
...
static void MPRE(blit_subpixel)(unsigned char *adst, const unsigned char *asrc, unsigned char r,
                                unsigned char g, unsigned char b, unsigned char a, int num)
{
  const unsigned char *src = asrc;
  BLEND_TYPE *dst = (BLEND_TYPE *)adst;
...
#if FORMAT_HOW == DI_32_RGBA || FORMAT_HOW == DI_32_BGRA || FORMAT_HOW == DI_32_ARGB || \
    FORMAT_HOW == DI_32_ABGR
...
#ifndef INLINE_ALPHA
  unsigned char *src_alpha = c->srca, *dst_alpha = c->dsta;
#endif
