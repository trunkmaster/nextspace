...
**** TODO Shortcuts
     ...
     к Preferences. А значит эти настройки должны пойти в Workspace.*** TODO .preferences as document associated with Preferences
...
***** TODO Keyboard
      ...
      - <Alt+конпка> - работает, если нет такого сочетания в меню. Другими
