...
******* TODO Появление окон Workspace
        ...
        фокуса на меню и окнах Workspace.
******* TODO WindowMaker: После перезапуска приложения съзжают вниз
        ...
        (падение, kill -9).
******* TODO Панель переключение между приложениями/окнами
...
******* DONE Старт приложений без окон (только меню)
...
******** приложение присутствует в списке при переключении по Alt-Tab
         Поскольку это отдельная сложная тема - непосредственно с фокусом
         слабо связанная - перенес в группу задачи "Окна и меню".
...
****** TODO Описать в отдельном документе все, что касается Look&Feel
       Общая концепция.
