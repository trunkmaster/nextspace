...
****** TODO Создать сеттеры для всех настроек в Defaults
***** TODO При изменении main window считывать настройки с него
      ...
      2. То, чем оперирует окно (класс TerminalWindow или Session?). Эти же
         настройки хранятся в файле сессии *.term. Сохраняются при вызове
         пункта меню "Shell->Save" и "Shell->Save As...".
      При вызове "Preferences", "Set Title" настройки запрашиваются у
      TerminalWindow.
      При нажатии на кнопку "Set Default" отображаются настройки в 
***** TODO При изменении шрифта пересчитывать Bold...
      ...если в Color стоит галочка.
      И еще какая-то беда с RobotoMono-Bold например. Пока нормально работет
      только с LiberationMono.
***** TODO Startup
****** TODO Auto-Launch
