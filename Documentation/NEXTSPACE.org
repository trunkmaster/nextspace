...
****** TODO Параметры для Shell
       При выборе какого-то shell из PopUp метка "Command:" меняется на "Shell
       Parameters:".
...
****** Поддержка сессий это:
       - возможность сохранять текущие настройки в отдельном файле 
         (меню Shell->Save As...) в файлы ~/Librayry/Terminal/*.term;
...
******* TODO Переработать создание окон из session файла
******* TODO Проверить работу нового кода
