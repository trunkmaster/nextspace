...
***** TODO Fonts
****** TODO Window Preferences
       При изменении шрифта, пересчитывать и устанавливать заново resize
       increment.
       UPDATE: все намного серьезней - нужно сделать review коду, который
       устанавливает размер TerminalView, плюс разобраться со сменой resize
       increment на лету. Есть ощущение, что оно не меняется.
****** TODO Font menu
