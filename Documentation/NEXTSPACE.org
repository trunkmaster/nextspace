...
****** TODO Адаптировать Shell под Sessions
...
****** TODO (?) Shell
       ...
       команду, которая запускается в терминале. Или нет?
...
***** TODO Startup
****** TODO Startup File
       Implement setting and saving startup file.
