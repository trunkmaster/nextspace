...
**** DONE Шрифт Roboto рисуется с большими интервалами
     ...
     все стало хорошо.
**** TODO Отображение нормального текста
...
**** TODO Выделять bold цветом и шрифтом
**** TODO Выделять blink цветом, определенным в Preferences
**** TODO Программа top не рисует заголовок (названия ресурсов процессов)
