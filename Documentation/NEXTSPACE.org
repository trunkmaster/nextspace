...
******* TODO Клик внутри окна
        ...
        GNUstep и WindowMaker ведут себя неправильно - варианту 1. 
...
******* TODO WindowMaker: После перезапуска приложения съзжают вниз
        ...
        (падение, kill -9).
******* TODO Переключение между приложениями/окнами
