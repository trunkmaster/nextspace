...
***** TODO Рисовать год как картинку
***** TODO Реагировать на изменение глобальных настроек
      ~/Library/Prefrences/NXGlobalDomain.plist - NSLanguages
...
***** TODO Размещать файлы NextSpace в ~/Library/Preferences/.NextSpace
****** /Мысли
       ...
       Структура каталогов:
       - ~/Library/Preferences/.WindowMaker:
         - WindowMaker
         - WMGLOBAL
         - WMRootMenu
         - WMState
         - WMWindowAttributes
       - ~/Library/Preferences/.NextSpace:
         - NXGlobalDomain.plist - глобальные настройки для приложений и
           фреймворков NextSpace: NXClockView24Hour, клавиатура, мышь, сеть,
           звук и т.д.;
         - Displays* - мультимониторные конфигурации;
         - Настройки приложений, которые пишутся через NXDefaults (формат
           ...
           Пока будет так.
****** TODO Размещать файлы настроек WindowMaker в ~/L/P/.WindowMaker
****** TODO Читать настройки из ~/L/P/.NextSpace/NXGlobalDomain by default
****** TODO Слать notification при изменении ~/L/P/.NextSpace/NXGlobalDomain
