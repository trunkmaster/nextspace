...
***** TODO Проверить корректность работы различных параметров
      - after "OK" button pressed futher changes won't change state of "OK"
        button and panel.
**** TODO Keyboard + Preferences | Linux Emulation
***** TODO Keyboard
...
***** TODO Preferences | Linux Emulation
      ...
      Emulation".
**** TODO (?) Скролл колесом мышки
     Нужно скроллить по одной строке или как указано в Preferences.app?
     Настройки мыши, который устанавливаются в Preferences должны читаться
