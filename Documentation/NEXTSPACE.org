...
****** TODO Focus
       ...
       По-идее это должно работать так:
        - appicon: XCreateWindow, XMapRaised - иконка получает InputFocus;
          предыдущее приложение теряет фокус, меню еще нет;
          если приложение было запущено с опцией -NXAutoLaunch фокус 
          возвращается к приложению, у которого фокус был до этого.
...
******** TODO отображается appicon с "забеленной иконкой"
...
******** TODO отображает appicon с нормальным видом иконки
******** TODO появляется меню и приложение получает фокус
******** TODO shortcut'ы работают
...
******** TODO запускаеся и отображает appicon
******** TODO меню НЕ отображается
******** TODO фокус на приложение НЕ передается 
         На текущем приложении фокус не "моргает".
******** TODO shortcut'ы не работают
         Приложением НЕ перехватываются и НЕ обрабатываются.
******* TODO Приложение с одним окном
******* TODO Приложение c несоколькими окнами
******* TODO Приложение с окном(ами) и панелями (utility, modal)
