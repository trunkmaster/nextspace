...
****** TODO Font menu
       ...
       + Font Panel - почти, нужно при вызове назначать текущий фонт окна
       + Bold - нужно менять на Bold Off и реально это обеспечить
       + Italic - нужно менять на Italic Off и реально это обеспечить
       + Larger
       + Smaller
...
****** DONE Обновлять FontPanel 
       ...устанавливать шрифт выбранного окна в FontPanel если открыта.
***** TODO Startup
****** TODO Auto-Launch
