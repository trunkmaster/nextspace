...
*** TODO miniwindow: рисунок заголовка
    Сделать рисунок заголовка miniwindow таким же, как у GNUstep.
*** TODO miniwindow: шрифт
    Посмотреть что там с антиалиасингом и хинтингом мелких шрифтов.
** TODO Размер заголовка окна и кнопок в заголовке
...
*** TODO NXClockView
**** TODO При пустом NSLanguages Attributes Inspector падает
