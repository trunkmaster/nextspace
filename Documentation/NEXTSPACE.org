...
****** TODO Defaults: добавить метод сохранения в файл
****** TODO Shell | Save
...
****** TODO Shell | Save As
       ...
       Если были загружены настройки по-умолчанию предлагаемое имя пустое,
       каталог стандарный для хранения сессий (~/Library/Terminal).
       Если была загружена сессия, предлагать имя <имя сессии>-Copy.term.
****** TODO Shell | Open
