...
***** TODO Не обрабатывать параметры коммандной строки
...
********* Работа gnustep-back при различных сценариях
...
******** TODO Привести NSWindow.h и GNUstep.h в WindowMaker к одному виду
         Ну и естетсвенно проверить, что получилось в результате. Если все
         OK - посмотреть код работы с панелями и сделать изменения с учетом
         новых цифр в NS*WindowLevel.
...
******* TODO WindowMaker: После перезапуска приложения съзжают вниз
        ...
        (падение, kill -9).
******* TODO Панел переключение между приложениями/окнами
