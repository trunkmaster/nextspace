...
****** TODO polymorphicOpts
       Переименовать outputMatrix в polymorphicMatrix. В зависимости от выбора
       в executeTypeBtn менять надписи:
       ...
       + New Window
       - Idle Window
****** TODO Кнопка "Save" disabled если "OK" enabled
****** TODO shellMatrix disabled если выбрана опция "Idle Window"
