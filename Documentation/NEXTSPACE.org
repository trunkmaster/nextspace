...
******* TODO Слишком простые приложения
        Корректная работа с приложениями, у которых есть только appicon и
        меню.
        Нужно добавить/заставить работать опцию "autolaunch". Если такаия
        опция указана при запуске приложения - меню не отображается совсем.
******* TODO Появление окон Workspace
        ...
        отображения меню и регистрации приложений WindowMaker'ом (см. "Слишком
        простые приложения"). Нужно думать...
