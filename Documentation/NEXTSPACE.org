...
***** TODO (HACK) Правильное отображение appicon при первом старте
...
******* TODO Старт приложений без окон (только меню)
        Ожидаемое поведение:
        - приложение запускаеся и отображается appicon с "забеленной иконкой";
        - приложение отображает appicon с нормальным видом иконки;
        - появляется меню и приложение получает фокус;
        - клавиатурные комбинации приложением перехватываются и
          обрабатываются.
******* TODO Старт приложений с опцией '-NXAutoLaunch YES'
        Ожидаемое поведение:
        - приложение запускаеся и отображает NSIconWindow;
        - меню НЕ отображается;
        - фокус на приложение НЕ передается (на текущем приложении фокус не
          "моргает");
        - клавиатурные комбинации приложением НЕ перехватываются и НЕ
          обрабатываются.
******* TODO Появление окон Workspace
        ...
        отображения меню и регистрации приложений WindowMaker'ом (см. "Старт
        приложений без окон"). Нужно думать...
