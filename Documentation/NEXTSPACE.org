...
****** TODO при обновлении размера окна, поля Rows и Columns должны обновляться.
****** TODO при изменении шрифта, пересчитывать и устанавливать занового resize increment.
***** TODO Startup
****** TODO Auto-Launch
