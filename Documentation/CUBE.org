...
***** TODO Default layout: учитывать состояние LID
      Если LID->closed делать монитор неактивным.
***** TODO Оставлять конфигурацию подключенных мониторов
      ... и применять дефолтные настройки для новых мониторов.
      Что делать с Layout?
      На какое место ставить найденный монитор - слева направо.
...
***** TODO Workspace: размещать Dock и IconYard на mainDisplay
****** DONE При изменении размеров размеров во время работы
       Сделал в Workspace+WindowMaker.m (XWUpdateScreenInfo()).
****** TODO При старте Workspace (WindowMaker)
***** TODO Login: перемещать окно на mainDisplay посередине
****** TODO При старте
****** TODO После старта (нужен EeventLoop), в активном режиме
...
***** TODO В VirtualBox двигание слайдеров = залипание/падение
...
****** TODO Показывать отключенный монитор
****** TODO Arrange (метод и кнопка)
****** TODO Отображение Dock и Icon Yard на 'Main Display'
...
***** TODO Принимать уведомления об измнениях в конф. мониторов
