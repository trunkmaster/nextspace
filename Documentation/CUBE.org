...
**** TODO Запись и чтение конфигов с layout'ами
...
****** DONE Запись:
      - [NXScreen saveCurrentDisplayLayout];
        - (NSString*)[NXScreen _displayConfigFileName]
        - (BOOL)[[NXScreen currentLayout] writeToFile: atomically:YES]
****** DONE Чтение:
...
***** TODO Класть конфиги в ~/Library/Peferences/.NextSpace -> Workspace
      ...
      Нужно проверить Login, Workspace и Preferences, чтобы пользовались
      этими методами.
