...
**** TODO Localization: language, units, paper, encoding
     ...
     GNUSTEP_STRING_ENCODING - определяется автоматически из системной локали.
***** TODO Список Language - отдельный виджет
      С перетаскиваемыми языками, но не так, как это сделано в NSTableView.
      NSScrollView с documentView в виде NSMatrix.
