...
**** TODO Использование XRRScreenResources
***** TODO Нужно определить когда обязательно нужно обновлять
      NXDisplay:
      ...
      which uses NXSystem. NXSystem should never update XRRScreenConfiguration
      by itself.
***** TODO Уменьшить количество инициализаций (сейчас - многовато)
...
***** TODO Подключение нового монитора на лету
      Оставлять конфигурацию подключенных мониторов и применять дефолтные
      настройки для новых мониторов.
      Что делать с Layout?
