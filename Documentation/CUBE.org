...
***** TODO Text Encoding
      GNUSTEP_STRING_ENCODING - определяется автоматически из системной
      локали - нужно проверить.
      Вроде работает: при установленной локале en_US.UTF-8 выдает NSUTF8StringEncoding.
