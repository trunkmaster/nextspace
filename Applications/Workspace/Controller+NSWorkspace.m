...
static NSString *GSWorkspacePreferencesChanged = @"GSWorkspacePreferencesChanged";
...
@interface _WorkspaceCenter: NSNotificationCenter
{
...
@implementation	_WorkspaceCenter
...
- (id)initNSWorkspace
{
  ...
  _workspaceCenter = [_WorkspaceCenter new];
