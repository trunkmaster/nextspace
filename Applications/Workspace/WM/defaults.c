...
WDefaultEntry optionList[] = {
  ...
  {"ResizeDisplay", "none", seGeomDisplays, &wPreferences.size_display, getEnum, NULL, NULL, NULL},
  {"MoveDisplay", "none", seGeomDisplays, &wPreferences.move_display, getEnum, NULL, NULL, NULL},
