                     ...
                     withArgs:(NSArray *)values;
{
    ...
    [outputDict setObject:command
                   forKey:@"LaunchPath"];
    [outputDict setObject:directory
                   forKey:@"CurrentDirectoryPath"];
    [outputDict setObject:values
    ...
    [outputDict setObject:[[[NSString alloc] initWithData:outData encoding:NSASCIIStringEncoding] autorelease]
